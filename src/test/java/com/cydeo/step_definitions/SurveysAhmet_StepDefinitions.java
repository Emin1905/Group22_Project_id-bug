...
public class SurveysAhmet_StepDefinitions {

    SurveysMokhi_Page surveysAhmet_page = new SurveysMokhi_Page();
    ...
    public void user_logins_by_entering_valid_username_and_valid_password(String string, String string2) {
        ...
        surveysAhmet_page.usernameInput.sendKeys(string);
        surveysAhmet_page.passwordInput.sendKeys(string2);
    ...
    public void by_clicking_the_login_button_user_goes_to_the_homepage() {
        ...
        surveysAhmet_page.loginBtn.click();
        Assert.assertTrue(surveysAhmet_page.homePageMsg.isDisplayed());
    }
    ...
    public void user_clicks_more_from_the_menu_bar_and_selects_surveys() {
        ...
        surveysAhmet_page.moreBtn.click();
        surveysAhmet_page.surveysBtn.click();
    ...
    public void user_goes_to_surveys_page_and_clicks_on_create_button() {
        ...
        surveysAhmet_page.createBtn.click();
    ...
    public void user_should_see_new_survey_form() {
        ...
        Assert.assertTrue(surveysAhmet_page.surveyTitle.isDisplayed());
    }

    @When("user leaves the Survey Title field empty")
    public void userLeavesTheSurveyTitleFieldEmpty() {

        surveysAhmet_page.surveyTitle.sendKeys("");
        surveysAhmet_page.saveBtn.click();
    }

    @Then("user should see an error message")
    public void userShouldSeeAnErrorMessage() {

        Assert.assertTrue(surveysAhmet_page.errorMsg.isDisplayed());
    }

    @When("user enters survey title {string}")
    public void userEntersSurveyTitle(String arg0) {

        surveysAhmet_page.surveyTitle.sendKeys(arg0);
        surveysAhmet_page.saveBtn.click();
    }
    ...
    public void userShouldSeeSurveyCreatedMessage() {
        ...
        Assert.assertTrue(surveysAhmet_page.surveyCreatedMsg.isDisplayed());
    }

    @And("user clicks on Surveys module")
    public void userClicksOnSurveysModule() {

        surveysAhmet_page.surveysModule.click();
    }
    ...
    public void userShouldSeeCreatedSurveyIsListed() {
        ...
        for (WebElement eachTitle : allTitle) {
            ...
            if(eachTitleText.equals("Ahmet Survey")){
